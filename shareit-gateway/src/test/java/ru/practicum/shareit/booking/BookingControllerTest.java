...
public class BookingControllerTest {
    ...
    @Test
    void shouldCreateBookingResponseTest() throws Exception {
        Mockito
                .when(bookingClient.bookItem(anyLong(), any(BookingCreateDto.class)))
                .thenReturn(ResponseEntity.ok().build());


        ResponseEntity<Object> responseEntity = bookingClient.bookItem(1L, bookingCreateDto);
    ...
    @Test
    void shouldNotCreateBookingWhenStartDateOrEndDateIsNotValid() throws Exception {
        bookingCreateDto.setStart(null);
